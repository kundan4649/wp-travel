        ...
        case 'burger-right':
            ...
            <div class="aux-header aux-header-elements-wrapper aux-float-layout">
                ...
                <div class="aux-header-elements">
                    ...
                    ?>
                    <?php if ( 'none' !== $menu ) { ?>
                    <div 2 class="aux-menu-box aux-off aux-auto-locate aux-end aux-fill aux-tablet-center" >
                    <?php
        ...
        case 'burger-left':
            ...
            <div class="aux-header aux-header-elements-wrapper aux-float-layout">
                ...
                <div class="aux-header-elements">
                    ...
                    ?>
                    <?php if ( 'none' !== $menu ) { ?>
                    <div 3 class="aux-menu-box aux-off aux-auto-locate aux-start aux-fill aux-tablet-center" >
                    <?php
                        /* The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.*/
                        wp_nav_menu( array(
                            'menu' => $menu,
        ...
        case 'horizontal-menu-center':
            ...
            <div class="aux-header aux-header-elements-wrapper aux-float-layout">
                ...
                <div class="bottom-bar secondary-bar aux-phone-off aux-float-wrapper">
                    <?php if ( 'none' !== $menu ) { ?>
                    <!-- menu -->
                    <div 4 class="aux-menu-box <?php echo $submenu_below ? 'aux-middle aux-center-middle' : 'aux-fill aux-center'; ?>">
<?php
    /* The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.*/
        ...
        case 'logo-in-middle-menu':
            ...
            <div class="aux-header aux-header-elements-wrapper aux-float-layout">
                ...
                <div class="aux-header-elements">
                    ...
                    <!-- menu -->
                    <div 5 class="aux-menu-box aux-phone-off aux-auto-locate aux-center-middle aux-phone-center-middle aux-fill aux-tablet-center" data-tablet=".aux-header .secondary-bar-2">
                    <?php
                        /* The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.*/
                        wp_nav_menu( array( 'menu' => $menu, 'container_id' => 'master-menu-main-header', 'theme_location' => 'header-primary' ) );
                    ?>
        ...
        case 'logo-left-menu-right-over':
            ...
            <div class="aux-header aux-header-elements-wrapper aux-float-layout aux-over-content">
                ...
                <div class="aux-header-elements">
                    ...
                    <?php if ( 'none' !== $menu ) { ?>
                    <!-- menu -->
                    <div 6 class="aux-menu-box aux-phone-off aux-auto-locate aux-end <?php echo $submenu_below ? 'aux-middle aux-tablet-center-middle' : 'aux-fill aux-tablet-center'; ?>" data-tablet=".aux-header .secondary-bar">
                    <?php
                        /* The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.*/
                        wp_nav_menu( array( 'menu' => $menu, 'container_id' => 'master-menu-main-header', 'theme_location' => 'header-primary' ) );
                    ?>
        ...
        case 'logo-left-menu-bottom-left':
            ...
            <div class="aux-header aux-header-elements-wrapper aux-float-layout">
                ...
                <div class="bottom-bar secondary-bar aux-float-wrapper aux-sticky-off aux-phone-off">
                    <?php if ( 'none' !== $menu ) { ?>
                    <!-- menu -->
                    <div 7 class="aux-menu-box aux-phone-off aux-auto-locate aux-start <?php echo $submenu_below ? 'aux-middle' : 'aux-fill'; ?>" data-sticky-move="#logo" data-sticky-move-method="after">
                    <?php
                        /* The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.*/
                        wp_nav_menu( array( 'menu' => $menu, 'container_id' => 'master-menu-main-header', 'theme_location' => 'header-primary' ) );
                    ?>
        ...
        case 'vertical':
            ...
            <div class="aux-vertical-menu-side aux-header aux-header-elements-wrapper <?php echo esc_attr( $items_align ) ;?>" <?php echo $bg_color ;?> >
                ...
                <div class="aux-vertical-menu-elements aux-header-elements ">
                    ...
                    <!-- menu -->
                    <div 8 class="aux-menu-box aux-phone-off aux-auto-locate aux-tablet-center'; ?>" data-tablet=".aux-header .secondary-bar-2">
                    <?php
                        if ( 'none' !== $menu ) {
                            /* The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.*/
                            wp_nav_menu( array(
                ...
                ?>
                    <div class="aux-header aux-header-elements-wrapper aux-float-layout aux-over-content">
                        ...
                        <div class="aux-header-elements">
                            ...
                            <div 9 class="aux-menu-box aux-phone-off aux-auto-locate aux-center-middle aux-phone-center-middle aux-fill aux-tablet-center" data-tablet=".aux-header .secondary-bar-2">
                                <?php
                                    /* The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.*/
                                    wp_nav_menu( array( 'menu' => $menu, 'container_id' => 'master-menu-main-header', 'theme_location' => 'header-primary' ) );
                                ?>
            ...
            <div class="aux-header aux-header-elements-wrapper aux-float-layout">
                ...
                <div class="aux-header-elements">
                    ...
                    <?php if ( 'none' !== $menu ) { ?>
                    <div 10 class="aux-menu-box aux-off aux-auto-locate aux-end aux-fill aux-tablet-center" >
                    <?php
                        /* The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.*/
                        wp_nav_menu( array(
                            'menu' => $menu,
        ...
        default:
            ...
            <div class="aux-header aux-header-elements-wrapper aux-float-layout">
                ...
                <div class="aux-header-elements">
                    ...
                    <?php if ( 'none' !== $menu ) { ?>
                    <!-- menu -->
                    <div 1 class="aux-menu-box aux-phone-off aux-auto-locate aux-end <?php echo $submenu_below ? 'aux-middle aux-tablet-center-middle' : 'aux-fill aux-tablet-center'; ?>" data-tablet=".aux-header .secondary-bar">
                    <?php
                        /* The menu assiged to the primary position is the one used.  If none is assigned, the menu with the lowest ID is used.*/
                        wp_nav_menu( array( 'menu' => $menu, 'container_id' => 'master-menu-main-header', 'theme_location' => 'header-primary' ) );
                    ?>
